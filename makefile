...
PRODUCTS=$(BUILDDIR)/SSDT-XOSI.aml $(BUILDDIR)/SSDT-USB.aml $(BUILDDIR)/SSDT-UIAC.aml $(BUILDDIR)/SSDT-GPRW.aml $(BUILDDIR)/SSDT-PNLF.aml $(BUILDDIR)/SSDT-KBD.aml $(BUILDDIR)/SSDT-IGPU.aml $(BUILDDIR)/SSDT-HDEF.aml $(BUILDDIR)/SSDT-HDAU.aml $(BUILDDIR)/SSDT-BATT.aml
